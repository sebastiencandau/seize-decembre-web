...
export const followingMessage = async (message: string, playerName: string) => {
    ...
    switch (message) {
        ...
        case "tu ne voudrais pas qu'on se voit avant ?":
            return {
                messages: [
                    {
                        msg: "mmh",
        ...
        case "non, je parlais de se voir juste toi et moi":
            ...
            choices[0] = "rdv";
            await localStorage.setItem('choices', JSON.stringify(choices));
            return {
                messages: [
                    {
                        msg: "ow",
        ...
        case "oui, avec les autres ":
            ...
            return {
                messages: [
                    {
                        msg: "alors autant se voir à mon anniversaire 😋",
                        type: null,
                        received: true
                    },
                    {
                        msg: "ce sera chouette",
                        type: null,
                        received: true
                    }
                ],
        ...
        case "c'est difficile de trouver sa place":
            return {
                messages: [
                    ...
                    {
                        msg: `"The National - "Don't Swallow the Cap"`,
                        type: "music",
                        received: true,
                        link: "shallow_the_cap"
                    },
                    {
                ...
                choices: [
                    ...
                    "pourquoi se sentir triste, on est les personnages principaux",
                    "j'irai écouter + tard"
                ]
            };
        ...
        case "pourquoi se sentir triste, on est les personnages principaux":
            return {
                messages: [
                    {
                ...
                choices: [
                    "tu ne voudrais pas qu'on se voit avant ?",
                    "je verrai si je peux me libérer",
                    "je viendrai avec plaisir !"
                ]
            };
